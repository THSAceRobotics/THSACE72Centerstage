...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2166.0255310320235; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1905.491175564053; // x position of the perpendicular encoder (in tick units)
    }
