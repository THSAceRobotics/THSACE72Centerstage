...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1928.3111512775677; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1847.4034368005384; // x position of the perpendicular encoder (in tick units)
    }
